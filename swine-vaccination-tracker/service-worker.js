/* service-worker.js - OFFLINE 100% GUARANTEED v1.0.0 (manual update check) */
...
self.addEventListener('activate', (event) => {
  ...
  event.waitUntil((async () => {
    ...
    console.log('[SW] ✅ Kích hoạt xong (update chỉ chạy khi người dùng bấm "Kiểm tra cập nhật" từ trang).');
  })());
});
...
<title>Theo dõi tiêm vaccine heo - Offline</title>
<style>
